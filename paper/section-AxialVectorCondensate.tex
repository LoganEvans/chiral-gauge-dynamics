...
\end{equation}
\noindent Finally, when we consider the Worm-Gear effect, which measures the correlation between a quark spinning on a longitudinal axis and its transfers kick, we find:
\begin{equation}
