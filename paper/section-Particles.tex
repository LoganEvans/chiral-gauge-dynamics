...
We have resolved that \suTwo particles in CGD require more than a single color, that these particles do not decay into the vacuum, and that a mass gap forces these particles to possess gravitational stress energy \todo{is that worded badly?}. This can characterize the stability of an electron, but hadrons also possess confinement, \todo{wtf... why is kinematicStringConfinement even necessary?}
