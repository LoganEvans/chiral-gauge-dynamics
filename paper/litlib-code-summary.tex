...
abbrev §\phantomsection\label{lean:CGD.Gravity.TetradField}§CGD.Gravity.TetradField := InternalIndex → §\hyperref[lean:CGD.Gravity.SpacetimeIndex]{\detokenize{SpacetimeIndex}}§ → §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → ℂ
