...
-- MODULE: CGD.AntiSelfDualSector.Summary
--------------------------------------------------------------------
/--
...
-/
theorem §\phantomsection\label{lean:CGD.AntiSelfDualSector.antiSelfDualSectorSummary}§CGD.AntiSelfDualSector.antiSelfDualSectorSummary
  ...
  (∀ (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§) (μ ν : Fin 4),
    (∀ m p, §\hyperref[lean:CGD.Foundations.isSu2]{\detokenize{isSu2}}§ (pu.toUniverse.asd_sector m p).val) →
...
-/
theorem §\phantomsection\label{lean:CGD.Cosmology.cosmologySummary}§CGD.Cosmology.cosmologySummary
  (pu : §\hyperref[lean:CGD.Axioms.PhysicalUniverse]{\detokenize{PhysicalUniverse}}§) :
  ...
  (∀ (phaseRegion : Set §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§), phaseRegion ⊆ pu.bulk →
    (∀ x ∈ phaseRegion, §\hyperref[lean:CGD.Cosmology.isFully4DSymmetric]{\detokenize{isFully4DSymmetric}}§ (fun mu nu => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector mu nu x)) →
    ∀ x ∈ phaseRegion, ∃ c : Complex, c ≠ 0 ∧ §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{urbantkeMetric}}§ (fun mu nu => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector mu nu x) = c • 1)
  ∧
  ...
  (∀ (F : Fin 4 → Fin 4 → §\hyperref[lean:CGD.Foundations.SL2C]{\detokenize{SL2C}}§) (lambda_scale : ℂ),
    let F_scaled := fun μ ν => §\hyperref[lean:CGD.Foundations.toSl2c]{\detokenize{toSl2c}}§ (lambda_scale^2 • (F μ ν).val);
    (∀ μ ν, §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{urbantkeMetric}}§ F_scaled μ ν = lambda_scale^6 * §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{urbantkeMetric}}§ F μ ν) ∧
    (§\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{urbantkeMetric}}§ F_scaled).det = lambda_scale^24 * (§\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{urbantkeMetric}}§ F).det)
  ∧
  ...
  (∀ (phaseRegion : Set §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§),
    (∀ x ∈ phaseRegion, §\hyperref[lean:CGD.Cosmology.isFully4DSymmetric]{\detokenize{isFully4DSymmetric}}§ (fun mu nu => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector mu nu x)) →
    ∀ x ∈ phaseRegion,
...
-- MODULE: CGD.Foundations.Summary
--------------------------------------------------------------------
/--
...
-/
theorem §\phantomsection\label{lean:CGD.Foundations.foundationsSummary}§CGD.Foundations.foundationsSummary
  (pu : §\hyperref[lean:CGD.Axioms.PhysicalUniverse]{\detokenize{CGD.Axioms.PhysicalUniverse}}§)
  [clairaut : §\hyperref[lean:Litlib.Y1976.rudin1976principles.ClairautTheoremNDimensional]{\detokenize{Litlib.Y1976.rudin1976principles.ClairautTheoremNDimensional}}§]
  ...
  (∀ (i j : Fin 4) (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§), 
    ∑ μ : Fin 4, §\hyperref[lean:CGD.Foundations.partialDeriv]{\detokenize{partialDeriv}}§ μ (fun p => §\hyperref[lean:CGD.Foundations.emergentElectricCurrent]{\detokenize{emergentElectricCurrent}}§ (§\hyperref[lean:CGD.Foundations.abelianFieldStrength]{\detokenize{abelianFieldStrength}}§ pu i j) μ p) x = 0)
  ∧
  ...
  (∀ (L : ((Fin 4 → Fin 4 → §\hyperref[lean:CGD.Foundations.ChiralM]{\detokenize{ChiralM}}§) → Complex)),
    (∀ F U, (∀ μ ν, §\hyperref[lean:CGD.Foundations.isSpin4cAlgebra]{\detokenize{isSpin4cAlgebra}}§ (F μ ν)) → 
      (∀ μ ν, §\hyperref[lean:CGD.Foundations.isSpin4cAlgebra]{\detokenize{isSpin4cAlgebra}}§ (U * F μ ν * U⁻¹)) → 
      L (fun μ ν => U * F μ ν * U⁻¹) = L F) →
    (∀ Λ : Matrix (Fin 4) (Fin 4) ℂ, 
      ...
      (∀ μ ν, §\hyperref[lean:CGD.Foundations.isSpin4cAlgebra]{\detokenize{isSpin4cAlgebra}}§ (∑ α : Fin 4, ∑ β : Fin 4, (Λ μ α * Λ ν β) • F α β)) → 
      L (fun μ ν => ∑ α : Fin 4, ∑ β : Fin 4, (Λ μ α * Λ ν β) • F α β) = Matrix.det Λ * L F) →
    (∀ (c : ℂ) (F : Fin 4 → Fin 4 → §\hyperref[lean:CGD.Foundations.ChiralM]{\detokenize{ChiralM}}§), 
      (∀ μ ν, §\hyperref[lean:CGD.Foundations.isSpin4cAlgebra]{\detokenize{isSpin4cAlgebra}}§ (F μ ν)) → L (fun μ ν => c • F μ ν) = c^2 * L F) →
    (∀ (F G : Fin 4 → Fin 4 → §\hyperref[lean:CGD.Foundations.ChiralM]{\detokenize{ChiralM}}§), 
      (∀ μ ν, §\hyperref[lean:CGD.Foundations.isSpin4cAlgebra]{\detokenize{isSpin4cAlgebra}}§ (F μ ν)) → (∀ μ ν, §\hyperref[lean:CGD.Foundations.isSpin4cAlgebra]{\detokenize{isSpin4cAlgebra}}§ (G μ ν)) → 
      L (fun μ ν => F μ ν + G μ ν) + L (fun μ ν => F μ ν - G μ ν) = 2 * L F + 2 * L G) →
    ∃ c : ℂ, ∀ F, (∀ μ ν, §\hyperref[lean:CGD.Foundations.isSpin4cAlgebra]{\detokenize{isSpin4cAlgebra}}§ (F μ ν)) → L F = c * ∑ μ : Fin 4, ∑ ν : Fin 4, ∑ ρ : Fin 4, ∑ σ : Fin 4, §\hyperref[lean:CGD.Gravity.epsilon4]{\detokenize{CGD.Gravity.epsilon4}}§ μ ν ρ σ * Matrix.trace (F μ ν * F ρ σ))
  ∧
  ...
  (∀ (v : ℝ → §\hyperref[lean:CGD.Axioms.PhysicalUniverse]{\detokenize{CGD.Axioms.PhysicalUniverse}}§)
    [§\hyperref[lean:Litlib.Y1965.spivak1965calculus.DivergenceTheoremR4Compact]{\detokenize{Litlib.Y1965.spivak1965calculus.DivergenceTheoremR4Compact}}§ (fun x mu => §\hyperref[lean:CGD.Foundations.variationCurrent]{\detokenize{variationCurrent}}§ v 0 mu x)]
    [§\hyperref[lean:Litlib.Y1976.rudin1976principles.LeibnizIntegralRule]{\detokenize{Litlib.Y1976.rudin1976principles.LeibnizIntegralRule}}§ (fun s x => §\hyperref[lean:CGD.Foundations.lagrangianDensity]{\detokenize{lagrangianDensity}}§ (fun mu nu => §\hyperref[lean:CGD.Foundations.curvature]{\detokenize{curvature}}§ (fun m p => (v s).toUniverse.spin4c_connection m p) mu nu x))],
    §\hyperref[lean:CGD.Foundations.isValidPhysicalVariation]{\detokenize{isValidPhysicalVariation}}§ v → deriv (fun t => §\hyperref[lean:CGD.Foundations.physicalUniverseAction]{\detokenize{physicalUniverseAction}}§ (v t)) 0 = 0)
  ∧
  ...
  (∀ (A : §\hyperref[lean:CGD.Axioms.Sl2cGaugeField]{\detokenize{CGD.Axioms.Sl2cGaugeField}}§) (ρ μ ν : Fin 4) (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§),
    §\hyperref[lean:CGD.Foundations.covariantDeriv]{\detokenize{covariantDeriv}}§ A ρ μ ν x + §\hyperref[lean:CGD.Foundations.covariantDeriv]{\detokenize{covariantDeriv}}§ A μ ν ρ x + §\hyperref[lean:CGD.Foundations.covariantDeriv]{\detokenize{covariantDeriv}}§ A ν ρ μ x = 0)
...
-/
theorem §\phantomsection\label{lean:CGD.Gravity.gravitySummary}§CGD.Gravity.gravitySummary
  (pu : §\hyperref[lean:CGD.Axioms.PhysicalUniverse]{\detokenize{PhysicalUniverse}}§) :
  ...
  (∀ (urbantke_tetrad : §\hyperref[lean:CGD.Gravity.TetradField]{\detokenize{TetradField}}§)
     (Psi : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → Fin 2 → Fin 2 → Fin 2 → Fin 2 → ℂ)
     [§\hyperref[lean:Litlib.Y1991.capovilla1991pure.Eq2_2b]{\detokenize{Litlib.Y1991.capovilla1991pure.Eq2_2b}}§ §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ (§\hyperref[lean:CGD.Gravity.cgd_dSigma]{\detokenize{cgd_dSigma}}§ urbantke_tetrad) (§\hyperref[lean:CGD.Gravity.cgd_omega]{\detokenize{cgd_omega}}§ pu.toUniverse) (§\hyperref[lean:CGD.Gravity.cgd_Sigma]{\detokenize{cgd_Sigma}}§ urbantke_tetrad) §\hyperref[lean:CGD.Gravity.cgd_eps2_up]{\detokenize{cgd_eps2_up}}§]
     [§\hyperref[lean:Litlib.Y1991.capovilla1991pure.Eq2_2c]{\detokenize{Litlib.Y1991.capovilla1991pure.Eq2_2c}}§ §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ (§\hyperref[lean:CGD.Gravity.cgd_R]{\detokenize{cgd_R}}§ pu.toUniverse) Psi (§\hyperref[lean:CGD.Gravity.cgd_Sigma]{\detokenize{cgd_Sigma}}§ urbantke_tetrad)]
     [§\hyperref[lean:Litlib.Y1991.capovilla1991pure.Theorem_Eq2_2c_RicciFlat]{\detokenize{Litlib.Y1991.capovilla1991pure.Theorem_Eq2_2c_RicciFlat}}§ 
       (Spacetime := pu.bulk)
       (theta := fun (x : pu.bulk) => §\hyperref[lean:CGD.Gravity.cgd_theta]{\detokenize{cgd_theta}}§ urbantke_tetrad x.val) 
       (g := fun (x : pu.bulk) m n => §\hyperref[lean:CGD.Gravity.metricFromTetrad]{\detokenize{metricFromTetrad}}§ urbantke_tetrad m n x.val) 
       (eps2_down := §\hyperref[lean:CGD.Gravity.cgd_eps2_down]{\detokenize{cgd_eps2_down}}§)
  ...
  (∀ (sqrt_g mu eta : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → ℂ)
     (Psi_3x3 M_3x3 : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → Matrix (Fin 3) (Fin 3) ℂ),
     §\hyperref[lean:Litlib.Y1991.capovilla1991pure.Theorem_Volume_Element_Identity]{\detokenize{Litlib.Y1991.capovilla1991pure.Theorem_Volume_Element_Identity}}§ §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ sqrt_g mu eta Psi_3x3 M_3x3 →
     ∀ x ∈ pu.bulk, (sqrt_g x)^2 = (mu x)^2)
  ∧
  ...
  (∀ (isSmooth : (pu.bulk → ℂ) → Prop)
     ...
     (du : ℂ → (Fin 4 → ℂ))
     (isSinglePole : (Fin 4 → Fin 4 → pu.bulk → ℂ) → (ℂ → pu.bulk) → Prop)
     [§\hyperref[lean:Litlib.Y2003.nakahara2003geometry.Theorem_ContractedBianchi]{\detokenize{Litlib.Y2003.nakahara2003geometry.Theorem_ContractedBianchi}}§ pu.bulk (Fin 4) isSmooth (§\hyperref[lean:CGD.Gravity.bulkDeriv]{\detokenize{bulkDeriv}}§ pu)]
     [§\hyperref[lean:Litlib.Y1984.urbantke1984integrability.Eq10_Symmetry]{\detokenize{Litlib.Y1984.urbantke1984integrability.Eq10_Symmetry}}§]
     [§\hyperref[lean:Litlib.Y1951.papapetrou1951spinning.Eq2_12]{\detokenize{Litlib.Y1951.papapetrou1951spinning.Eq2_12}}§ pu.bulk ℂ 
       (fun p => Matrix.of (fun m n => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p.val) m n))
       (fun p => Matrix.of (fun m n => §\hyperref[lean:CGD.Gravity.matrixInv4x4]{\detokenize{CGD.Gravity.matrixInv4x4}}§ (fun a b => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p.val) a b) m n))
       (fun p rho mu nu => §\hyperref[lean:CGD.Gravity.christoffel]{\detokenize{CGD.Gravity.christoffel}}§ (fun m n p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p') m n) rho mu nu p.val)
       (fun m n p => §\hyperref[lean:CGD.Gravity.emergentStressEnergy]{\detokenize{emergentStressEnergy}}§ (fun a b p' => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p') m n p.val)
     ...
     (∀ x : pu.bulk, ∃ (F F_dual : Fin 3 → Fin 4 → Fin 4 → ℂ) (epsilon3 : Fin 3 → Fin 3 → Fin 3 → ℂ),
       ...
       (∀ mu nu, §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b x.val) mu nu =
         (-1 / 6 : ℂ) * Finset.sum Finset.univ (fun a => Finset.sum Finset.univ (fun b => Finset.sum Finset.univ (fun c => Finset.sum Finset.univ (fun alpha => Finset.sum Finset.univ (fun beta => epsilon3 a c b * F a mu alpha * F_dual c alpha beta * F b beta nu))))))) →
     (∀ i j, isSmooth (fun p => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p.val) i j)) →
     (∀ i j, isSmooth (fun p => §\hyperref[lean:CGD.Gravity.matrixInv4x4]{\detokenize{CGD.Gravity.matrixInv4x4}}§ (fun m n => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p.val) m n) i j)) →
     (∀ rho mu nu, isSmooth (fun p => §\hyperref[lean:CGD.Gravity.christoffel]{\detokenize{CGD.Gravity.christoffel}}§ (fun m n p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p') m n) rho mu nu p.val)) →
     (∀ p : pu.bulk, ∀ rho mu nu, §\hyperref[lean:CGD.Gravity.christoffel]{\detokenize{CGD.Gravity.christoffel}}§ (fun m n p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p') m n) rho mu nu p.val = 
       (1/2 : ℂ) * ∑ sigma : Fin 4, §\hyperref[lean:CGD.Gravity.matrixInv4x4]{\detokenize{CGD.Gravity.matrixInv4x4}}§ (fun m n => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p.val) m n) rho sigma * (
         §\hyperref[lean:CGD.Gravity.bulkDeriv]{\detokenize{bulkDeriv}}§ pu mu (fun p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p'.val) sigma nu) p +
         §\hyperref[lean:CGD.Gravity.bulkDeriv]{\detokenize{bulkDeriv}}§ pu nu (fun p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p'.val) mu sigma) p -
         §\hyperref[lean:CGD.Gravity.bulkDeriv]{\detokenize{bulkDeriv}}§ pu sigma (fun p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p'.val) mu nu) p)) →
     (∀ p : pu.bulk, ∀ mu nu, §\hyperref[lean:CGD.Gravity.ricciTensor]{\detokenize{CGD.Gravity.ricciTensor}}§ (fun m n p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p') m n) mu nu p.val = 
       ∑ rho : Fin 4, (§\hyperref[lean:CGD.Gravity.bulkDeriv]{\detokenize{bulkDeriv}}§ pu rho (fun p' => §\hyperref[lean:CGD.Gravity.christoffel]{\detokenize{CGD.Gravity.christoffel}}§ (fun m n p'' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p'') m n) rho mu nu p'.val) p -
             §\hyperref[lean:CGD.Gravity.bulkDeriv]{\detokenize{bulkDeriv}}§ pu nu (fun p' => §\hyperref[lean:CGD.Gravity.christoffel]{\detokenize{CGD.Gravity.christoffel}}§ (fun m n p'' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p'') m n) rho mu rho p'.val) p +
             ∑ lambda : Fin 4, (§\hyperref[lean:CGD.Gravity.christoffel]{\detokenize{CGD.Gravity.christoffel}}§ (fun m n p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p') m n) rho lambda rho p.val * §\hyperref[lean:CGD.Gravity.christoffel]{\detokenize{CGD.Gravity.christoffel}}§ (fun m n p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p') m n) lambda mu nu p.val -
                   §\hyperref[lean:CGD.Gravity.christoffel]{\detokenize{CGD.Gravity.christoffel}}§ (fun m n p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p') m n) rho lambda nu p.val * §\hyperref[lean:CGD.Gravity.christoffel]{\detokenize{CGD.Gravity.christoffel}}§ (fun m n p' => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p') m n) lambda mu rho p.val))) →
     (isSinglePole (fun m n p => §\hyperref[lean:CGD.Gravity.emergentStressEnergy]{\detokenize{emergentStressEnergy}}§ (fun a b p' => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p') m n p.val) γ) →
     ∀ s alpha, du s alpha + ∑ mu : Fin 4, ∑ nu : Fin 4, §\hyperref[lean:CGD.Gravity.christoffel]{\detokenize{CGD.Gravity.christoffel}}§ (fun m n p => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p) m n) alpha mu nu (γ s).val * u s mu * u s nu = 0)
  ∧
...
--------------------------------------------------------------------
noncomputable def §\phantomsection\label{lean:CGD.Particles.densitizedHamiltonian}§CGD.Particles.densitizedHamiltonian (E B : Matrix (Fin 3) (Fin 3) ℂ) : ℂ := 
...
-/
theorem §\phantomsection\label{lean:CGD.Particles.kinematicStringConfinement}§CGD.Particles.kinematicStringConfinement :
  ∀ (E B : Matrix (Fin 3) (Fin 3) ℂ) (E_z : ℂ),
    §\hyperref[lean:CGD.Particles.isCrushedString]{\detokenize{isCrushedString}}§ E E_z →
    ∃ (v : Fin 3 → ℂ), (∑ i : Fin 3, v i * v i = 1) ∧
      §\hyperref[lean:CGD.Particles.densitizedHamiltonian]{\detokenize{densitizedHamiltonian}}§ E B = (1 / 2 : ℂ) * E_z^2 + (1 / 2 : ℂ) * ∑ a : Fin 3, ∑ b : Fin 3, B a b * B a b
...
-/
def §\phantomsection\label{lean:CGD.Particles.isCrushedString}§CGD.Particles.isCrushedString (E : Matrix (Fin 3) (Fin 3) ℂ) (E_z : ℂ) : Prop :=
...
-/
theorem §\phantomsection\label{lean:CGD.Particles.particlesSummary}§CGD.Particles.particlesSummary
  (pu : §\hyperref[lean:CGD.Axioms.PhysicalUniverse]{\detokenize{PhysicalUniverse}}§) :
  ...
  (∀ (windingNumber : (§\hyperref[lean:CGD.Foundations.S3]{\detokenize{S3}}§ → §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§) → ℤ)
     ...
     [§\hyperref[lean:Litlib.Y2003.nakahara2003geometry.CartanMaurerTopology]{\detokenize{Litlib.Y2003.nakahara2003geometry.CartanMaurerTopology}}§ (§\hyperref[lean:CGD.Foundations.S3]{\detokenize{S3}}§ → §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§) Continuous windingNumber cartanMaurerIntegral]
     [§\hyperref[lean:Litlib.Y1975.belavin1975pseudoparticle.Eq8]{\detokenize{Litlib.Y1975.belavin1975pseudoparticle.Eq8}}§ §\hyperref[lean:CGD.Foundations.S3]{\detokenize{S3}}§ §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§ Continuous windingNumber cartanMaurerIntegral],
     cartanMaurerIntegral 1 = 0 → ¬ §\hyperref[lean:CGD.Particles.isHomotopicConnection]{\detokenize{isHomotopicConnection}}§ §\hyperref[lean:CGD.Particles.bpstInstanton]{\detokenize{bpstInstanton}}§ 0)
  ∧
  ...
  (∀ (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§)
     ...
     (∀ μ ν i, eval_SL2C (§\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.asd_sector μ ν x) i = ∑ j, F_bar_ij i j * Sigma_bar j μ ν) →
     §\hyperref[lean:Litlib.Y2011.krasnov2011plebanski.Eq16]{\detokenize{Litlib.Y2011.krasnov2011plebanski.Eq16}}§ 
       Sigma 
       Sigma_bar 
       (fun μ ν => §\hyperref[lean:CGD.Gravity.matrixInv4x4]{\detokenize{matrixInv4x4}}§ (fun m n => §\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{urbantkeMetric}}§ (fun a b => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b x) m n) μ ν)
       (fun μ ν => §\hyperref[lean:CGD.Gravity.emergentStressEnergy]{\detokenize{emergentStressEnergy}}§ (fun a b p => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p) μ ν x)
       T_ij →
     §\hyperref[lean:Litlib.Y2011.krasnov2011plebanski.Eq17]{\detokenize{Litlib.Y2011.krasnov2011plebanski.Eq17}}§ 
       Lambda 
       G 
       F_ij 
       F_bar_ij 
     ...
     plebanski_matter_eqs →
     (∃ μ ν, §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.asd_sector μ ν x ≠ 0) →
     ∃ ρ μ, §\hyperref[lean:CGD.Gravity.emergentStressEnergy]{\detokenize{emergentStressEnergy}}§ (fun a b p => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.sd_sector a b p) ρ μ x ≠ 0)
...
noncomputable def §\phantomsection\label{lean:CGD.Quantum.emergentDiracOperator}§CGD.Quantum.emergentDiracOperator (u : §\hyperref[lean:CGD.Axioms.Universe]{\detokenize{Universe}}§) (e : §\hyperref[lean:CGD.Gravity.TetradField]{\detokenize{TetradField}}§) (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§) (nu : Fin 4) : Matrix (Fin 4) (Fin 4) Complex :=
  ∑ mu, ∑ a, (e a mu x) • (§\hyperref[lean:Litlib.Math.Dirac.gammaVec]{\detokenize{gammaVec}}§ a * covariantSpinorDeriv u x mu nu)
...
--------------------------------------------------------------------
def §\phantomsection\label{lean:CGD.Quantum.isGlobalMinimum}§CGD.Quantum.isGlobalMinimum {α : Type*} (Energy : α → ℝ) (state : α) : Prop :=
...
-/
theorem §\phantomsection\label{lean:CGD.Quantum.algebraicStringBreakingLimit}§CGD.Quantum.algebraicStringBreakingLimit
  (energyFunc : (Fin 4 → §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → §\hyperref[lean:CGD.Foundations.SL2C]{\detokenize{SL2C}}§) → ℝ)
  (intactState snappedState : ℝ → Fin 4 → §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → §\hyperref[lean:CGD.Foundations.SL2C]{\detokenize{SL2C}}§)
  {sigma M : ℝ} [eb : §\hyperref[lean:Litlib.Y2001.bali2001qcd.FluxTubeStringBreaking]{\detokenize{FluxTubeStringBreaking}}§ (Fin 4 → §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → §\hyperref[lean:CGD.Foundations.SL2C]{\detokenize{SL2C}}§) energyFunc intactState snappedState sigma M]
  (pu : §\hyperref[lean:CGD.Axioms.PhysicalUniverse]{\detokenize{PhysicalUniverse}}§)
  (L : ℝ)
  (h_L_pos : L > 0)
  (h_intact : pu.toUniverse.sd_sector = intactState L)
  (h_L_crossover : L > (2 * M) / sigma) :
  ¬ §\hyperref[lean:CGD.Quantum.isGlobalMinimum]{\detokenize{isGlobalMinimum}}§ energyFunc pu.toUniverse.sd_sector
...
-- MODULE: CGD.Quantum.Measurement.Attractors
--------------------------------------------------------------------
/--
...
-/
noncomputable def §\phantomsection\label{lean:CGD.Quantum.Measurement.isSeparatrixBoundary}§CGD.Quantum.Measurement.isSeparatrixBoundary (E_0 M : ℝ) (A B : §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§) : Prop :=
...
-/
theorem §\phantomsection\label{lean:CGD.Quantum.Measurement.physicalBornRule}§CGD.Quantum.Measurement.physicalBornRule
  (pu : §\hyperref[lean:CGD.Axioms.PhysicalUniverse]{\detokenize{PhysicalUniverse}}§)
  ...
  (detector_state : §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§)
  (E_0 M : ℝ) (hE0 : E_0 ≠ 0)
  (theta_separatrix : ℝ)
  -- Coordinate Definition: theta_separatrix is the angle parameterized by the geometric correlation
  (h_angle : Real.cos theta_separatrix = (§\hyperref[lean:CGD.Quantum.geometricBellCorrelation]{\detokenize{geometricBellCorrelation}}§ (evaluateBoundary pu.toUniverse.sd_sector) detector_state).re)
  -- The physical state lies exactly on the dynamical string-breaking separatrix
  (h_separatrix : §\hyperref[lean:CGD.Quantum.Measurement.isSeparatrixBoundary]{\detokenize{isSeparatrixBoundary}}§ E_0 M (evaluateBoundary pu.toUniverse.sd_sector) detector_state) :
  (§\hyperref[lean:CGD.Quantum.Measurement.hopfVolumePrimitive]{\detokenize{hopfVolumePrimitive}}§ Real.pi - §\hyperref[lean:CGD.Quantum.Measurement.hopfVolumePrimitive]{\detokenize{hopfVolumePrimitive}}§ theta_separatrix) / 
  (§\hyperref[lean:CGD.Quantum.Measurement.hopfVolumePrimitive]{\detokenize{hopfVolumePrimitive}}§ Real.pi - §\hyperref[lean:CGD.Quantum.Measurement.hopfVolumePrimitive]{\detokenize{hopfVolumePrimitive}}§ 0) = 1 - M / E_0
...
-/
theorem §\phantomsection\label{lean:CGD.Quantum.Measurement.finiteLiouvilleBoundaryFlow}§CGD.Quantum.Measurement.finiteLiouvilleBoundaryFlow
  (n : ℕ)
  [ms : MeasureTheory.MeasureSpace (Fin n → ℝ)]
  (f : (Fin n → ℝ) → (Fin n → ℝ))
  (g : ℝ → (Fin n → ℝ) → (Fin n → ℝ))
  [liouville : §\hyperref[lean:Litlib.Y1989.arnold1989mathematical.LiouvilleTheoremND]{\detokenize{LiouvilleTheoremND}}§ (n := n)]
...
-/
theorem §\phantomsection\label{lean:CGD.Quantum.quantumSummary}§CGD.Quantum.quantumSummary
  (pu : §\hyperref[lean:CGD.Axioms.PhysicalUniverse]{\detokenize{PhysicalUniverse}}§) :
  ...
  (∀ {BoundaryManifold : Type*} [TopologicalSpace BoundaryManifold] [Nonempty BoundaryManifold]
    ...
    (windingNumber : (BoundaryManifold → §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§) → ℤ)
    (cartanMaurerIntegral : (BoundaryManifold → §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§) → ℝ)
    [§\hyperref[lean:Litlib.Y2003.nakahara2003geometry.CartanMaurerTopology]{\detokenize{Litlib.Y2003.nakahara2003geometry.CartanMaurerTopology}}§ (BoundaryManifold → §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§) (Continuous : (BoundaryManifold → §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§) → Prop) windingNumber cartanMaurerIntegral]
    [§\hyperref[lean:Litlib.Y1975.belavin1975pseudoparticle.Eq8]{\detokenize{Litlib.Y1975.belavin1975pseudoparticle.Eq8}}§ BoundaryManifold §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§ (Continuous : (BoundaryManifold → §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§) → Prop) windingNumber cartanMaurerIntegral],
    §\hyperref[lean:Litlib.Y1975.belavin1975pseudoparticle.IsHomeomorphism]{\detokenize{IsHomeomorphism}}§ (boundaryMap pu.toUniverse.sd_sector.val) →
    cartanMaurerIntegral (boundaryMap pu.toUniverse.sd_sector.val) = 1 ∨ 
    cartanMaurerIntegral (boundaryMap pu.toUniverse.sd_sector.val) = -1)
  ∧
  ...
  (∀ (e : §\hyperref[lean:CGD.Gravity.TetradField]{\detokenize{TetradField}}§) (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§) (nu : Fin 4),
    (∀ mu, §\hyperref[lean:CGD.Foundations.partialDerivChiral]{\detokenize{partialDerivChiral}}§ nu (fun p => pu.toUniverse.spin4c_connection mu p) x = 0) →
    §\hyperref[lean:CGD.Quantum.emergentDiracOperator]{\detokenize{emergentDiracOperator}}§ pu.toUniverse e x nu = 
    ∑ mu, ∑ a, (e a mu x) • (§\hyperref[lean:Litlib.Math.Dirac.gammaVec]{\detokenize{gammaVec}}§ a * §\hyperref[lean:CGD.Foundations.curvature]{\detokenize{curvature}}§ (fun m p => pu.toUniverse.spin4c_connection m p) mu nu x))
  ∧
  ...
  (∀ (energyFunc : (Fin 4 → §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → §\hyperref[lean:CGD.Foundations.SL2C]{\detokenize{SL2C}}§) → ℝ)
    (intactState snappedState : ℝ → Fin 4 → §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → §\hyperref[lean:CGD.Foundations.SL2C]{\detokenize{SL2C}}§)
    {sigma M : ℝ} [§\hyperref[lean:Litlib.Y2001.bali2001qcd.FluxTubeStringBreaking]{\detokenize{Litlib.Y2001.bali2001qcd.FluxTubeStringBreaking}}§ (Fin 4 → §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → §\hyperref[lean:CGD.Foundations.SL2C]{\detokenize{SL2C}}§) energyFunc intactState snappedState sigma M]
    (L : ℝ),
    L > 0 →
  ...
  (∀ (matrixExp : Matrix (Fin 2) (Fin 2) ℂ → Matrix (Fin 2) (Fin 2) ℂ)
    ...
    (alpha L : ℝ),
    (∀ t, pu.toUniverse.sd_sector 1 (§\hyperref[lean:CGD.Quantum.straightLinePath]{\detokenize{straightLinePath}}§ t) = §\hyperref[lean:CGD.Quantum.fluxTubeFrame]{\detokenize{fluxTubeFrame}}§ 1 (§\hyperref[lean:CGD.Quantum.straightLinePath]{\detokenize{straightLinePath}}§ t)) →
    §\hyperref[lean:CGD.Quantum.macroscopicObservable]{\detokenize{macroscopicObservable}}§ (§\hyperref[lean:CGD.Quantum.holonomy]{\detokenize{holonomy}}§ matrixExp) (fun mu p => §\hyperref[lean:CGD.Quantum.rotateYAxis]{\detokenize{rotateYAxis}}§ (fun m p => pu.toUniverse.sd_sector m p) alpha mu p) 1 L =
    (Complex.cos (L:ℂ)) • 1 + (Complex.I * Complex.sin (L:ℂ)) • §\hyperref[lean:CGD.Quantum.obs_M]{\detokenize{obs_M}}§ alpha)
  ∧
  ...
  (∀ (matrixExp : Matrix (Fin 2) (Fin 2) ℂ → Matrix (Fin 2) (Fin 2) ℂ)
    (t : ℝ),
    (∀ s, (pu.toUniverse.sd_sector.val 1 (§\hyperref[lean:CGD.Quantum.straightLinePath]{\detokenize{straightLinePath}}§ s)).val = Complex.I • §\hyperref[lean:CGD.Foundations.sigmaZ]{\detokenize{sigmaZ}}§) →
    §\hyperref[lean:CGD.Quantum.macroscopicObservable]{\detokenize{macroscopicObservable}}§ (§\hyperref[lean:CGD.Quantum.holonomy]{\detokenize{holonomy}}§ matrixExp) pu.toUniverse.sd_sector.val 1 t = 
    §\hyperref[lean:CGD.Quantum.Holonomy.unitaryTimeEvolution]{\detokenize{CGD.Quantum.Holonomy.unitaryTimeEvolution}}§ matrixExp (-§\hyperref[lean:CGD.Foundations.sigmaZ]{\detokenize{sigmaZ}}§) t)
  ∧
  ...
  (∀ (evaluateBoundary : §\hyperref[lean:CGD.Axioms.Sl2cGaugeField]{\detokenize{Sl2cGaugeField}}§ → §\hyperref[lean:CGD.Foundations.SU2Group]{\detokenize{SU2Group}}§)
    ...
    (E_0 M : ℝ), E_0 ≠ 0 →
    ∀ (theta_separatrix : ℝ),
    Real.cos theta_separatrix = (§\hyperref[lean:CGD.Quantum.geometricBellCorrelation]{\detokenize{geometricBellCorrelation}}§ (evaluateBoundary pu.toUniverse.sd_sector) detector_state).re →
    §\hyperref[lean:CGD.Quantum.Measurement.isSeparatrixBoundary]{\detokenize{CGD.Quantum.Measurement.isSeparatrixBoundary}}§ E_0 M (evaluateBoundary pu.toUniverse.sd_sector) detector_state →
    (§\hyperref[lean:CGD.Quantum.Measurement.hopfVolumePrimitive]{\detokenize{CGD.Quantum.Measurement.hopfVolumePrimitive}}§ Real.pi - §\hyperref[lean:CGD.Quantum.Measurement.hopfVolumePrimitive]{\detokenize{CGD.Quantum.Measurement.hopfVolumePrimitive}}§ theta_separatrix) / 
    (§\hyperref[lean:CGD.Quantum.Measurement.hopfVolumePrimitive]{\detokenize{CGD.Quantum.Measurement.hopfVolumePrimitive}}§ Real.pi - §\hyperref[lean:CGD.Quantum.Measurement.hopfVolumePrimitive]{\detokenize{CGD.Quantum.Measurement.hopfVolumePrimitive}}§ 0) = 1 - M / E_0)
  ∧
  ...
  (∀ (n : ℕ)
    ...
    (f : (Fin n → ℝ) → (Fin n → ℝ))
    (g : ℝ → (Fin n → ℝ) → (Fin n → ℝ))
    [§\hyperref[lean:Litlib.Y1989.arnold1989mathematical.LiouvilleTheoremND]{\detokenize{LiouvilleTheoremND}}§ (n := n)],
  ...
  (∀ (dPsi : Fin 4 → §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → Matrix (Fin 4) (Fin 4) Complex) 
    (Psi : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ → Matrix (Fin 4) (Fin 4) Complex) (m : Complex) (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§),
    §\hyperref[lean:CGD.Quantum.localDiracOp]{\detokenize{localDiracOp}}§ (fun a => dPsi a x) = m • Psi x →
    let D0_mod := §\hyperref[lean:CGD.Quantum.modulatedTemporalDeriv]{\detokenize{modulatedTemporalDeriv}}§ (dPsi 0 x) (Psi x) m
    let D_space := §\hyperref[lean:CGD.Quantum.spatialDiracOp]{\detokenize{spatialDiracOp}}§ (fun mu => dPsi mu x)
  ...
  (∀ (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§), x ∈ pu.bulk →
...
-/
theorem §\phantomsection\label{lean:CGD.cgdSummary}§CGD.cgdSummary
  (pu : §\hyperref[lean:CGD.Axioms.PhysicalUniverse]{\detokenize{PhysicalUniverse}}§)
  [§\hyperref[lean:Litlib.Y1976.rudin1976principles.ClairautTheoremNDimensional]{\detokenize{Litlib.Y1976.rudin1976principles.ClairautTheoremNDimensional}}§]
  ...
  -- VI. PHENOMENOLOGY
  -- ====================================================================
  (∀ (mu : Fin 4) (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§),
    Matrix.trace (§\hyperref[lean:CGD.Phenomenology.axialField]{\detokenize{CGD.Phenomenology.axialField}}§ pu.toUniverse mu x) = 0)
  ∧
  (∀ (mu : Fin 4) (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§),
    §\hyperref[lean:CGD.Phenomenology.axialField]{\detokenize{CGD.Phenomenology.axialField}}§ (§\hyperref[lean:CGD.Phenomenology.paritySwap]{\detokenize{CGD.Phenomenology.paritySwap}}§ pu.toUniverse) mu x = - §\hyperref[lean:CGD.Phenomenology.axialField]{\detokenize{CGD.Phenomenology.axialField}}§ pu.toUniverse mu x)
  ∧
  (∀ (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§), x ∈ pu.bulk → (∀ μ ν, §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.asd_sector.val μ ν x = 0) →
    pu.toUniverse.sd_sector.val ≠ pu.toUniverse.asd_sector.val)
  ∧
  (∀ (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§), x ∈ pu.bulk → (∀ μ ν, §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{curvatureSl2c}}§ pu.toUniverse.asd_sector.val μ ν x = 0) →
    ∃ y mu, §\hyperref[lean:CGD.Phenomenology.axialField]{\detokenize{CGD.Phenomenology.axialField}}§ pu.toUniverse mu y ≠ 0)
  ∧
...
--------------------------------------------------------------------
class §\phantomsection\label{lean:Litlib.Y1989.arnold1989mathematical.LiouvilleTheoremND}§Litlib.Y1989.arnold1989mathematical.LiouvilleTheoremND§\textsuperscript{\pdftooltip{\cite{arnold1989mathematical}}{Reference: arnold1989mathematical}}§
    {n : ℕ}
...
--------------------------------------------------------------------
class §\phantomsection\label{lean:Litlib.Y2001.bali2001qcd.FluxTubeStringBreaking}§Litlib.Y2001.bali2001qcd.FluxTubeStringBreaking§\textsuperscript{\pdftooltip{\cite{bali2001qcd}}{Reference: bali2001qcd}}§ 
    (FluxTubeState : Type*)
