...
-- MODULE: CGD.Quantum.StateExclusion
--------------------------------------------------------------------
§\phantomsection\label{lean:CGD.Quantum.geometricStateExclusion}§theorem CGD.Quantum.geometricStateExclusion :
  ∀ (pu : §\hyperref[lean:CGD.Axioms.PhysicalUniverse]{\detokenize{CGD.Axioms.PhysicalUniverse}}§) (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{CGD.Foundations.SpacetimePoint}}§)
  (F1 F2 : Fin 4 → Fin 4 → §\hyperref[lean:CGD.Foundations.SL2C]{\detokenize{CGD.Foundations.SL2C}}§),
  §\hyperref[lean:CGD.Quantum.isColorAligned]{\detokenize{CGD.Quantum.isColorAligned}}§ F1 F2 →
    (∀ (mu nu : Fin 4),
        Eq (§\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{CGD.Foundations.curvatureSl2c}}§ pu.toUniverse.sd_sector.val mu nu x) (instHAdd.hAdd (F1 mu nu) (F2 mu nu))) →
      Eq (§\hyperref[lean:CGD.Gravity.urbantkeMetric]{\detokenize{CGD.Gravity.urbantkeMetric}}§ fun mu nu => §\hyperref[lean:CGD.Foundations.curvatureSl2c]{\detokenize{CGD.Foundations.curvatureSl2c}}§ pu.toUniverse.sd_sector.val mu nu x).det
        0

§\phantomsection\label{lean:CGD.Quantum.isColorAligned}§def CGD.Quantum.isColorAligned :
  (Fin 4 → Fin 4 → §\hyperref[lean:CGD.Foundations.SL2C]{\detokenize{CGD.Foundations.SL2C}}§) → (Fin 4 → Fin 4 → §\hyperref[lean:CGD.Foundations.SL2C]{\detokenize{CGD.Foundations.SL2C}}§) → Prop :=
  fun F1 F2 =>
  Exists fun T =>
    ∀ (mu nu : Fin 4),
      Exists fun c1 =>
        Exists fun c2 => And (Eq (F1 mu nu) (instHSMul.hSMul c1 T)) (Eq (F2 mu nu) (instHSMul.hSMul c2 T))
