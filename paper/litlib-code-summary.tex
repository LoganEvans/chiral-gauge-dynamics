...
noncomputable def §\phantomsection\label{lean:CGD.Gravity.ExactSolutions.solitonUniverse}§CGD.Gravity.ExactSolutions.solitonUniverse : §\hyperref[lean:CGD.Axioms.Universe]{\detokenize{Universe}}§ := {
  val := fun mu x => §\hyperref[lean:CGD.Foundations.embedSelfDual]{\detokenize{embedSelfDual}}§ (solitonAnsatz mu x)
  is_spin4c := by
    intros mu x
  ...
  sd_is_smooth := by
    intros mu i j
    have h : (fun (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§) => (§\hyperref[lean:CGD.Foundations.chiralProject]{\detokenize{chiralProject}}§ (§\hyperref[lean:CGD.Foundations.embedSelfDual]{\detokenize{embedSelfDual}}§ (solitonAnsatz mu x))).self_dual.val i j) = fun x => (solitonAnsatz mu x).val i j := by
      ext x
      rw [chiralProject_embedSelfDual]
    rw [h]
    have h2 : (fun x => (solitonAnsatz mu x).val i j) = fun x => §\hyperref[lean:CGD.Gravity.ExactSolutions.solitonAnsatzVal]{\detokenize{solitonAnsatzVal}}§ mu x i j := by
      ext x
    ...
    all_goals {
      dsimp [§\hyperref[lean:CGD.Gravity.ExactSolutions.solitonAnsatzVal]{\detokenize{solitonAnsatzVal}}§, §\hyperref[lean:CGD.Foundations.sigmaX]{\detokenize{sigmaX}}§, solitonSigmaY, §\hyperref[lean:CGD.Foundations.sigmaZ]{\detokenize{sigmaZ}}§, mkMat]
  ...
  asd_is_smooth := by
    intros mu i j
    have h : (fun (x : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§) => (§\hyperref[lean:CGD.Foundations.chiralProject]{\detokenize{chiralProject}}§ (§\hyperref[lean:CGD.Foundations.embedSelfDual]{\detokenize{embedSelfDual}}§ (solitonAnsatz mu x))).anti_self_dual.val i j) = fun _ => 0 := by
      ext x
...
noncomputable def §\phantomsection\label{lean:CGD.Gravity.ExactSolutions.testPoint}§CGD.Gravity.ExactSolutions.testPoint : §\hyperref[lean:CGD.Foundations.SpacetimePoint]{\detokenize{SpacetimePoint}}§ :=
  fun i => 
