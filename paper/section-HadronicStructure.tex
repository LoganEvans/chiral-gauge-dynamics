...
The prediction of an axial condensate goes beyond the proton radius puzzle. Next, we will demonstrate how the axial condensate produces the $V-A$ chiral interaction. The SD and ASD chiral sectors decompose into symmetric vector $(\mathcal{V})$ and axial $(\matchcal{A}^{\text{axial}})$ background fields:
\begin{align}
...
This observation leads us to look for... something about the TMD effects?
