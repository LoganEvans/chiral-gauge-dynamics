-- FILENAME: CGD/Gravity/RealityFilters/TypeO_IsotropicPart36_Metric11.lean

import CGD.Gravity.RealityFilters.TypeO_IsotropicPart35_Metric00
...
/--
Evaluates the x-x spatial component of the macroscopic Urbantke metric for the Type O cosmological vacuum.
Yields precisely -48 * adot * a^4, capturing the dynamic expansion of the spatial hypersurface.
-/
lemma typeO_metric_11 (a : ℝ → ℂ) (x : SpacetimePoint) (ha : DifferentiableAt ℝ a (x 0)) :
  urbantkeMetric (fun m n => curvatureSl2c (typeO_A a) m n x) 1 1 = -48 * (fderiv ℝ a (x 0) 1) * (a (x 0) * a (x 0)) ^ 2 := by
