-- FILENAME: CGD/Gravity/RealityFilters/TypeO_IsotropicPart37_Metric22.lean

import CGD.Gravity.RealityFilters.TypeO_IsotropicPart36_Metric11
...
/--
Evaluates the y-y spatial component of the macroscopic Urbantke metric for the Type O cosmological vacuum.
Yields precisely -48 * adot * a^4, capturing the dynamic expansion of the spatial hypersurface.
-/
lemma typeO_metric_22 (a : ℝ → ℂ) (x : SpacetimePoint) (ha : DifferentiableAt ℝ a (x 0)) :
  urbantkeMetric (fun m n => curvatureSl2c (typeO_A a) m n x) 2 2 = -48 * (fderiv ℝ a (x 0) 1) * (a (x 0) * a (x 0)) ^ 2 := by
