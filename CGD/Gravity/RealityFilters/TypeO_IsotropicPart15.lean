-- FILENAME: CGD/Gravity/RealityFilters/TypeO_IsotropicPart15.lean

import CGD.Gravity.RealityFilters.TypeO_IsotropicPart14
...
-/
lemma typeO_L_comm_1_2 (a : ℝ → ℂ) (x : SpacetimePoint) :
  typeO_L a 1 x * typeO_L a 2 x - typeO_L a 2 x * typeO_L a 1 x = (2 * Complex.I * (a (x 0) * a (x 0))) • sigma3.val := by
